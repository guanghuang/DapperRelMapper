...
/// <summary>
/// This class is used to map the result of a query to a model with fifteen child relationships.
/// </summary>
...
/// <typeparam name="TChild15">The type of the fifteenth child model.</typeparam>
public class SqlMultipleQueryWrapper<TParent, TKey, TChild1, TChild2, TChild3, TChild4, TChild5, TChild6, TChild7, TChild8, TChild9, TChild10, TChild11, TChild12, TChild13, TChild14, TChild15> : BaseSqlMultipleQueryWrapper<TParent, TKey>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SqlMultipleQueryWrapper{TParent, TKey, TChild1, TChild2, TChild3, TChild4, TChild5, TChild6, TChild7, TChild8, TChild9, TChild10, TChild11, TChild12, TChild13, TChild14, TChild15}"/> class.
    /// </summary>
    ...
    protected override async Task SetChildDataAsync(QueryConfiguration queryConfiguration, TParent parent, SqlMapper.GridReader reader, int childIndex)
    {
        switch (childIndex)
        {
            ...
            case 13:
                ...
                break;
            case 14:
                await SetChildDataAsync<TChild15>(queryConfiguration, parent, reader);
                break;
            default:
                throw new ArgumentOutOfRangeException(nameof(childIndex), "Child index must be between 0 and 14");
        }
    }
} 